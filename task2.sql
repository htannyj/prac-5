...
CREATE TABLE `Enrolments` (
  ...
  CONSTRAINT `Enrolments_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `Students` (`student_id`),
  CONSTRAINT `Enrolments_ibfk_2` FOREIGN KEY (`subject_code`) REFERENCES `Subjects` (`subject_code`)
...
INSERT INTO `Enrolments` VALUES ('a1111111','COMP SCI 1102',62),('a1111111','COMP SCI 2000',80),('a1111112','COMP SCI 1102',55),('a1111112','COMP SCI 2207',80),('a1111113','COMP SCI 1102',46),('a1111113','PHIL 2039',65),('a1111114','COMP SCI 2000',49),('a1111114','COMP SCI 2207',67);
...
INSERT INTO `Students` VALUES ('a1111111','Fang','Li','BE(Hons)(Soft)'),('a1111112','Jane','Brown','BE(Hons)(Soft)'),('a1111113','John','Doe','BE(Hons)(Soft)'),('a1111114','Wei','Zhang','BCompSc');
...
-- Dump completed on 2024-04-19  7:23:23
